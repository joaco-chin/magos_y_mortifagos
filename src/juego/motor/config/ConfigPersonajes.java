...
public abstract class ConfigPersonajes {
	...
	{"PetrificusTotalus", "Expelliarmus"};
	
	public static final int SEGUIDOR_COMUN_NIVEL_MAGIA = 2;
	public static final double SEGUIDOR_COMUN_MAX_VIDA = 95.5 * 2;
	public static final String[] SEGUIDOR_COMUN_HECHIZOS = 
	{"Expelliarmus", "Desmaius"};
	
	public static final int COMANDANTE_NIVEL_MAGIA = 3;
	public static final double COMANDANTE_MAX_VIDA = 95.5 * 2;
	public static final String[] COMANDANTE_HECHIZOS = 
	{"AvadaKedavra", "Expelliarmus"};
}
